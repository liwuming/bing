<?php
	...
	for($i=0;$i<35;$i++){
		$url = 'https://bing.sunweihu.com/2015%E5%B9%B4%E5%BF%85%E5%BA%94%E5%A3%81%E7%BA%B8/201510/201510 ('.$i.').jpg';
		$response = getHTML($url);
		if($response['code'] == 200){
			$imgDir = './2015/10/';   //必须是项目所在的绝对路径
			//要生成的图片名字
			$filename = '201510'.$i.'.png'; //新图片名称
